...
-(void)loaddata
{
    ...
    NSString *url = [NSString stringWithFormat:GET_practice2,uid,token,@"3",self.qtid];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    realCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:zhuanxiangidentfid forIndexPath:indexPath];

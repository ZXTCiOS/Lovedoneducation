...
- (void)setConfigration:(IBConfigration *)configration {
    if (!configration) {
        ...
        configration.phonestr = @"15510922836";
    ...
    _viewHeight = rect.size.height + 39 + 15 + 50 + 22+60;
    ...
    self.phoneLab.frame = CGRectMake(20, self.messageLab.frame.origin.y+20, kScreenWidth-100, 40);
    self.phoneLab.text = configration.phonestr;
